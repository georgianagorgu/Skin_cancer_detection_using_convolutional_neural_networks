...
from config import MODELS_DIR, PLOTS_DIR, RESNET_MODEL_PATH, RESNET_PLOT_PATH, TRAIN_DIR
...
def main():
    ...
    print(f"Model salvat la: {RESNET_MODEL_PATH}")
    print(f"Grafic salvat la: {RESNET_PLOT_PATH}")
