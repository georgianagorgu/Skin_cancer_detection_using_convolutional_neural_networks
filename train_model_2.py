...
MODEL_PATH = "D:/PROIECT_LICENTA/models/model_2_resnet50.keras"
PLOT_PATH = "D:/PROIECT_LICENTA/results/plots/training_plot_model_2_resnet50.png"
...
def plot_history(hist1, hist2):
    ...
    plt.title("Accuracy / Recall - Model 2")
    plt.xlabel("Epoch")
    plt.ylabel("Value")
    plt.legend()
...
print(f"Model 2 salvat la: {MODEL_PATH}")